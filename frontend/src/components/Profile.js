...
export default function Profile() {
    ...
    const fetchProfileDetails = async () => {
      ...
      try {
        const response = await axios.post(
          "http://localhost:3017/auth/profile",
          { userId }
        );
  ...
  const deleteProfileDetails = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3017/auth/deleteUser",
        { userId }
      );
  ...
  const updateProfileDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://localhost:3017/auth/updateUser",
      ...
      <div className="col-md-6">
        <div className="col-md-8 mx-auto">
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-4">
              <button className="btn btn-danger" onClick={deleteProfileDetails}>
                Delete
              </button>
            </div>
